...
public interface UConnectOrBuilder extends
   ...
   */
  java.util.List<edu.duke.erss.proto.UPStoWorld.UInitTruck> 
      getTrucksList();
  /**
   * <code>repeated .UInitTruck trucks = 2;</code>
   */
  edu.duke.erss.proto.UPStoWorld.UInitTruck getTrucks(int index);
  /**
   * <code>repeated .UInitTruck trucks = 2;</code>
   */
  int getTrucksCount();
   ...
   * <code>repeated .UInitTruck trucks = 2;</code>
   */
  java.util.List<? extends edu.duke.erss.proto.UPStoWorld.UInitTruckOrBuilder> 
      getTrucksOrBuilderList();
  /**
   * <code>repeated .UInitTruck trucks = 2;</code>
   */
  edu.duke.erss.proto.UPStoWorld.UInitTruckOrBuilder getTrucksOrBuilder(
      int index);
