...
public interface UGoDeliverOrBuilder extends
   ...
   */
  java.util.List<edu.duke.erss.proto.UPStoWorld.UDeliveryLocation> 
      getPackagesList();
  /**
   * <code>repeated .UDeliveryLocation packages = 2;</code>
   */
  edu.duke.erss.proto.UPStoWorld.UDeliveryLocation getPackages(int index);
  /**
   * <code>repeated .UDeliveryLocation packages = 2;</code>
   */
   ...
   * <code>repeated .UDeliveryLocation packages = 2;</code>
   */
  java.util.List<? extends edu.duke.erss.proto.UPStoWorld.UDeliveryLocationOrBuilder> 
      getPackagesOrBuilderList();
  /**
   * <code>repeated .UDeliveryLocation packages = 2;</code>
   */
  edu.duke.erss.proto.UPStoWorld.UDeliveryLocationOrBuilder getPackagesOrBuilder(
      int index);
